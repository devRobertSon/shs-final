...
export const QUIZ_CATEGORIES = [
  { id: "counsel-human", label: "면담-인성" },
  { id: "counsel-math", label: "면담-수학" },
  { id: "counsel-sci", label: "면담-과학" },
  { id: "polish-math", label: "수학 다듬기" },
  { id: "polish-sci", label: "과학 다듬기" },
  { id: "interview-math", label: "면접-수학" },
  { id: "interview-sci", label: "면접-과학" },
  { id: "sci", label: "과학 퀴즈" },
];
...
// 과학 숙제 항목 맵(homework)과 수학 숙제 날짜 맵(student.mathHomework)이 같은 규칙을 쓴다.
